...
5. Use the plugin's design and frontend skills where relevant — `frontend-design`, `design-system`, `accessibility`.
...
- [ ] Does it avoid looking like an unmodified component-library template?
